...
# !!! Main.UserApp is configured as an alias for Main.InitAI and you might encounter it in some tests
using Main.InitAI, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "InitAI tests" begin
  @includetests ARGS
end
